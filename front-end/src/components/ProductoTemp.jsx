...
function Producto({ user, producto, onActualizar, contenedor }) {
    ...
    useEffect(() => {
        const fetchColores = async () => {
            try {
                const response = await axios.get('http://192.168.0.131:5000/api/color');
        ...
        const fetchProductos = async () => {
            try {
                const response = await axios.get('http://192.168.0.131:5000/api/producto');
                ...
                <DesglozarPorcolor
                    ...
                    onDistribucionGuardada={(data) => {
                        ...
                        if (onActualizar && typeof onActualizar === 'function') {
                            ...
                            axios.get(`http://192.168.0.131:5000/api/contenedorProducto/${producto.idContenedor}`)
                                .then(response => {
