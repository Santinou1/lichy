...
function ContendorDetalle({user}){
    ...
    const handleCambioEstadoExitoso = (resultado) => {
        ...
        axios.get(`http://192.168.0.131:5000/api/contenedorProducto/contenedor/${id}`)
            .then(res => {
    ...
    useEffect(()=>{
        console.log(id)
        axios.get(`http://192.168.0.131:5000/api/contenedores/contenedor-detalle/${id}`).then((response)=>{
            setData(response.data[0]);
            console.log(response.data);
        });
        axios.get(`http://192.168.0.131:5000/api/contenedorEstado/${id}`).then((response)=>{
            console.log(response.data); 
        ...
        axios.get(`http://192.168.0.131:5000/api/contenedorProducto/${id}`).then((response)=>{
            setProductos(response.data);
        });
