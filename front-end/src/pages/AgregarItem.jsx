...
function AgregarItem() {
    ...
    const fetchItems = () => {
        axios.get(`http://192.168.0.131:5000/api/items/${item}`)
            .then((response) => {
    ...
    const onSubmit = (data) => {
        ...
        if (isEditing) {
            ...
            axios.put(`http://192.168.0.131:5000/api/items/${item}/${editingId}`, dataToUpdate)
            .then((response) => {
            ...
            console.log('URL:', `http://192.168.0.131:5000/api/items/${item}`);
            
            axios.post(`http://192.168.0.131:5000/api/items/${item}`, dataToSend)
            .then((response) => {
