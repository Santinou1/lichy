...
function ActualizarDetalles({data, setData, actualizarDetalles}){
    ...
    const onSubmit= (e) =>{
        e.preventDefault();
        axios.put(`http://gestion.lichy.local:5000/api/contenedores/detalle/${data.idContenedor}`,nuevaData).then((response)=>{
    ...
    useEffect(()=>{
        ...
        axios.get('http://gestion.lichy.local:5000/api/items/proveedor/').then((response)=>{
