...
function ActualizarDetalles({data, setData, actualizarDetalles}){
    ...
    const onSubmit= (e) =>{
        e.preventDefault();
        axios.put(`http://192.168.0.131:5000/api/contenedores/detalle/${data.idContenedor}`,nuevaData).then((response)=>{
    ...
    useEffect(()=>{
        ...
        axios.get('http://192.168.0.131:5000/api/items/proveedor/').then((response)=>{
