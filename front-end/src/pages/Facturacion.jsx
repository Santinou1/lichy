...
function Facturacion() {
  ...
  const cargarFacturas = async () => {
    try {
      ...
      const response = await axios.get('http://192.168.0.131:5000/api/facturas');
  ...
  const cargarPedidosDisponibles = async () => {
    try {
      ...
      const response = await axios.get('http://192.168.0.131:5000/api/pedidos/completados-sin-factura');
  ...
  const handleCrearFactura = async (e) => {
    ...
    try {
      // Esta llamada API necesitará implementarse en el backend
      await axios.post('http://192.168.0.131:5000/api/facturas', {
