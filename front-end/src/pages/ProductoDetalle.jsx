...
function ProductoDetalle() {
        ...
        const fetchData = async () => {
            try {
                const [cantidadColorRes, productoRes, cantidadContenedorRes, cantidadTotalRes, estadosRes, ubicacionesRes] = await Promise.all([
                    axios.get(`http://192.168.0.131:5000/api/producto/cantidad-por-color/${producto}`),
                    axios.get(`http://192.168.0.131:5000/api/items/producto/${producto}`),
                    axios.get(`http://192.168.0.131:5000/api/producto/cantidad-por-contenedor/${producto}`),
                    axios.get(`http://192.168.0.131:5000/api/producto/cantidad-total/${producto}`),
                    axios.get('http://192.168.0.131:5000/api/items/categorias'),
                    axios.get('http://192.168.0.131:5000/api/items/ubicaciones')
                ]);
    ...
    const filtrar = async () => {
        try {
            ...
            if (filtroTipo && filtroTipo !== 'color') {
                const response = await axios.get(`http://192.168.0.131:5000/api/producto/cantidad-filtro/${producto}`, {
                    headers: {
                        'x-filtro': filtroTipo,
                ...
                const response = await axios.get(`http://192.168.0.131:5000/api/producto/cantidad-por-color/${producto}`);
                const cantidadPorColorNombre = await obtenerColoresConNombres(response.data);
                setCantidadPorColor(cantidadPorColorNombre);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://192.168.0.131:5000/api/items/producto/${producto}`, formData);
